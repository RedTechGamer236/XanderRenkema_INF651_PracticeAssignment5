...
function averageAge (num1, num2, num3 = 0) {
  if(num3 === 0) return Math.round((num1 + num2) / 2);
...
function leetSpeak(word) {
  let leetSpeakIncomplete = word.replace(/e/g, "3");
  return leetSpeakIncomplete.replace(/a/g, "4");
}
